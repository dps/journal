...
\newcommand{\DayFillerWP}{%
	\DayFillerRowWP{\ding{46}}\break%
	\DayFillerRowWP{}\break%
	\DayFillerRowWP{}\break%
	\DayFillerRowWP{}\break%
	\DayFillerRowWP{}\break%
	\DayFillerRowWP{}\break%
...
\newcommand{\WeekGoalsWP}{%
	\makebox[0pt][l]{\smash[b]{\color{WriteBgSec}\rule[0.4\baselineskip]{\DayFillerWidthWP}{0.5\baselineskip}}}%
	\parbox[t]{\DayFillerTotWidthWP}{\large\WeekGoals\hrulefill}%
	\setlength{\unitlength}{1mm}%
        \begin{picture}(40,8)
                \put(20,0){\oval[2](40,8)[t]}
                \put(1,0){\large{}\ding{50}}
...
\newcommand{\NotesWP}{%
	...
	\setlength{\unitlength}{1mm}%
        \begin{picture}(40,8)
                %\put(20,0){\oval[2](40,8)[t]}
                \put(1,0){\large{}\includegraphics{exercise}}
